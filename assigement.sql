...
('B01', 1,'kannur main Library kannur',9057895286),
('B02', 2,'Tvm Branch Thiruvananthapuram',9875489657),
('B03', 3,'Kollam Branch Kollam',8085897596);
-- employee table 
...
(1, 'Anu Johnson', 'Librarian', 45000, 'B01'),
(2, 'Anu Johnson', 'Library Clerk', 55000, 'B01'),
(3, 'Billow Binu', 'Manager Librarian', 35000, 'B01'),
(4, 'Raju', 'Library Technician', 30000, 'B01'),
(5, 'Charlie', 'Library Assistant', 30000, 'B02'),
(6, 'Santhosh ', 'Library  staff', 28000, 'B02'),
(7, 'Sony', 'Library Maneger', 25000, 'B02'),
(8, 'Davis', 'Library Manager', 50000, 'B03'),
(9, 'Jay', 'Library Clerk', 25000, 'B03'),
(10, 'Sneha', 'Library Assistant', 25000, 'B03');
-- Books 
CREATE TABLE Books (
...
insert into Customer values (101, "Ansu","chegannur", default);
insert into Customer values (102, "Siju","chegannur", default);
insert into Customer values (103, "albin","Thiruvananthapuram", default);
insert into Customer values (104, "rameez","kollam", default);
insert into Customer values (105, "subin","kannur", default);
insert into Customer values (106, "sujith","kannur", default), 
(107, "Sanju","kollam", default),(108, "adithya","kollam", default),
(109, "keerthi","Thiruvananthapuram", default),(110, "sneha","kochi", default),
(111, "adil","kollam", default),(112, "pranav","kochi", default),
(113, "manju","kochi", default),(114, "justin","Thiruvananthapuram", default),
(115, "ajash","kollam", default), (116, "rathod","kollam", default),
(117, "teena","Thiruvananthapuram", default),(118, "praveen","kochi", default),
(119, "jobin","kollam", default),(120, "ikbal","Thiruvananthapuram", default);

insert into Customer values (90, "anju","Thiruvananthapuram", '2020-07-09 18:53:32');
insert into Customer values (91, "binu","kollam", '2020-08-09 18:53:32');
insert into Customer values (92, "seema","kannur", '2021-07-01 18:53:32');
-- IssueStatus
...
-- if books available books are in library then only we can takeit from library book table
delimiter $$
...
delimiter ;
-- if coutomer taken book from library if status will be Yes
delimiter $$
